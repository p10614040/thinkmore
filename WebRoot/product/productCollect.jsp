...
<body>
			...
			<div class="col-xs-3" id="myScrollspy">
				...
				<c:forEach var="cateGorys" items="${cateGorysSet}">
					<div class='TopTag opened'>
						<h3>
							<a
								href="/product/productTable?productType=${cateGorys.category.category_id}"
								class='menuItem'>${cateGorys.category.category_name}</a>
						</h3>
						<ul id='menuItem_1'>
							<c:forEach var="categoryBean" items="${cateGorys.categorylist}">
								<li><a
									href="/product/productTable?subProductType=${categoryBean.category.category_id}"><em>${categoryBean.categoryCount}</em>${categoryBean.category.category_name}</a></li>
							</c:forEach>
						</ul>
					</div>
				</c:forEach>
	...
	<script
		src="../components/bootstrap-table/locale/bootstrap-table-zh-CN.js"></script>
	...
	<script src="../js/app/productTable/productCollect.js"></script>
	<%
